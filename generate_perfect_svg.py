# Create the definitive pixel-precise IN-SPACe SVG matching the user's uploaded logo.png

svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 580 130" width="100%" height="100%" style="overflow: visible;">
  <defs>
    <style>
      .in-coral { fill: #CF7373; }
      .space-navy { fill: #12458D; }
    </style>
  </defs>

  <!-- ORBITAL ARC SWEEP -->
  <!-- Sweeps from beneath S, loops under SPACe, wraps up around 'e', and arches over the top -->
  <path d="M 215 90 C 230 106, 280 120, 360 120 C 445 120, 525 102, 545 68 C 555 52, 550 36, 528 26 C 485 10, 370 8, 275 34" 
        fill="none" 
        stroke="#12458D" 
        stroke-width="3.5" 
        stroke-linecap="round" />

  <!-- SATELLITE (Positioned along orbital path at top right ~ x=518, y=28) -->
  <g transform="translate(518, 27) rotate(-22)">
    ...
    <line x1="-26" y1="0" x2="-8" y2="0" stroke="#12458D" stroke-width="1.2" />
    ...
    <line x1="8" y1="0" x2="26" y2="0" stroke="#12458D" stroke-width="1.2" />
  </g>
  ...
  <g fill="#12458D" id="logo-SPACe">
    ...
    <!-- 'A' - Supersonic Delta Rocket Arrow (Navy Blue) -->
    <!-- Sharp nose pointing at x=348, y=14 -->
...
print("public/inspace_logo.svg generated successfully")
